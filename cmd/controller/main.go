...
import (
	...
	svctypes "github.com/aws-controllers-k8s/vpclattice-controller/apis/v1alpha1"
	svcresource "github.com/aws-controllers-k8s/vpclattice-controller/pkg/resource"

	"github.com/aws-controllers-k8s/vpclattice-controller/pkg/version"
)

var (
	awsServiceAPIGroup = "vpclattice.services.k8s.aws"
	awsServiceAlias    = "vpclattice"
